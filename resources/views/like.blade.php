...
<section id="contact">
    ...
    <div class=" col-md-6 container text-center">
        <button class="btn btn-light" onclick="popShoe()"><i class="bi bi-circle"></i></button>
        <button class="btn btn-light" onclick="popController()"><i class="bi bi-circle-fill"></i></button>
